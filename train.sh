...
python train.py --n_splits 5 --seed 12 --fold 1 --model_type "seresnext50" --loss "ceonehotohem" --lr 3e-1 --num_epoch 100 --batch_size 384 --valid_batch_size 800 --accumulation_steps 1 --num_workers 12 --early_stopping 20 
