...
python train.py --n_splits 5 --seed 12 --fold 1 --model_type "seresnext50" --loss "ceonehotohem" --lr 1e-2 --num_epoch 200 --batch_size 320 --valid_batch_size 1024 --accumulation_steps 1 --num_workers 14 --early_stopping 20 --apex --load_pretrain --start_epoch 139
