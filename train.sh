# python train.py --n_splits 5 --seed 12 --fold 0 --model_type "seresnext50" --loss "ceonehotohem" --lr 1e-1 --num_epoch 100 --batch_size 384 --valid_batch_size 320 --accumulation_steps 1 --num_workers 12 --early_stopping 10 --apex

# python train.py --n_splits 5 --seed 12 --fold 1 --model_type "seresnext50" --loss "ceonehotohem" --lr 1e-1 --num_epoch 100 --batch_size 384 --valid_batch_size 320 --accumulation_steps 1 --num_workers 12 --early_stopping 10 --apex

# python train.py --n_splits 5 --seed 12 --fold 2 --model_type "seresnext50" --loss "ceonehotohem" --lr 1e-1 --num_epoch 100 --batch_size 384 --valid_batch_size 320 --accumulation_steps 1 --num_workers 12 --early_stopping 10 --apex --load_pretrain

# python train.py --n_splits 5 --seed 12 --fold 3 --model_type "seresnext50" --loss "ceonehotohem" --lr 1e-1 --num_epoch 100 --batch_size 384 --valid_batch_size 320 --accumulation_steps 1 --num_workers 12 --early_stopping 10 --apex

# python train.py --n_splits 5 --seed 12 --fold 4 --model_type "seresnext50" --loss "ceonehotohem" --lr 1e-1 --num_epoch 100 --batch_size 384 --valid_batch_size 320 --accumulation_steps 1 --num_workers 12 --early_stopping 10 --apex
...
python train.py --n_splits 10 --seed 2019 --fold 0 --model_type "efficientnet-b3" --loss "ceonehotohem" --lr 2e-1 --num_epoch 100 --batch_size 128 --valid_batch_size 320 --accumulation_steps 2 --num_workers 12 --early_stopping 20 --apex --load_pretrain --start_epoch 5
